...
int func1(A* a) {
    std::cout << "func1 " << a->get_n() << std::endl; return a->get_n();
}
```
...
Use the function func1 and a script variable: 
```
...
```
class_type type_ExtA = se.eval(
    "ExtA = function(n)"
    "{"
    " var base = new A(n);"
    " base.proto = ExtA.prototype;"
    " return base;" "};"
    "ExtA.prototype.proto = A.prototype;"
...
function<tags::v8w> js_func = se.eval<function<tags::v8w> >( 
    "(function (a, b)" "{" " throw a + b;" "})" ); 
    try { 
        js_func.call<void>(10, 30); 
    } 
    catch (script_exception& e) { cout << "js_func exception: " << e.what() << endl; }
```

Catch C++ exceptions from Javascript: 

```
void func2(int n) { throw "native exception"; }
